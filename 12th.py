...
def normalize_passing_year(value):
    ...
    The document contains MONTH & YEAR OF EXAM.
    For this marksheet the OCR returns FEBRUARY-14.
    """
...
def extract_12th_marksheet_data(document_path):
    ...
    logger.info("==================================================")
    logger.info("STARTING 12TH MARKSHEET EXTRACTION")
    logger.info("==================================================")
    ...
    schema_override = documentai.DocumentSchema(
        ...
        description="12th HSC Marksheet extraction schema",
        entity_types=[
    ...
    logger.info("==================================================")
    logger.info(
        "12TH MARKSHEET EXTRACTION COMPLETED"
    )
    logger.info("==================================================")
...
if __name__ == "__main__":
    ...
    logger.info(
        "Starting 12th marksheet extraction application..."
    )

    try:

        data = extract_12th_marksheet_data(
            DOCUMENT_PATH
        )
