...
OUTPUT_FILE = "results/casteCertificate_1_gemini_result.json"
...
# ============================================================
# DIRECT GEMINI CASTE CERTIFICATE EXTRACTION
# ============================================================
...
def extract_with_gemini(file_path):
    ...
    logger.info("=" * 60)
    logger.info("DIRECT GEMINI CASTE CERTIFICATE EXTRACTION STARTED")
    logger.info("=" * 60)
    ...
    logger.info(
        "Reading caste certificate image..."
    )
...
"""
    ...
    logger.info(
        "Preparing caste certificate image for Gemini..."
    )
    ...
    logger.info("-" * 60)
    logger.info(
        "SENDING CASTE CERTIFICATE DIRECTLY TO GEMINI"
    )
    logger.info("-" * 60)
...
def main():
    ...
    logger.info("=" * 60)
    logger.info("CASTE CERTIFICATE DIRECT GEMINI TEST")
    logger.info("=" * 60)
