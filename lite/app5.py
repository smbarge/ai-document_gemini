...
def run_document_ai_ocr(document_path):
    ...
    logger.info(
        "Caste Certificate file found successfully"
    )
    ...
    logger.info("")
    logger.info(
        "Sending Caste Certificate to Enterprise Document AI..."
    )
    ...
    print("")
    print("=" * 70)
    print("ENTERPRISE OCR TEXT - CASTE CERTIFICATE")
    print("=" * 70)
...
The document is an Indian Caste Certificate.
...
- Do not infer information that is not supported by
  the document.
- Do not change the spelling of names.
- Preserve names exactly as written.
- Preserve caste and sub-caste exactly as written.
- Preserve certificate numbers exactly as written.
- Preserve dates exactly as written.
- Preserve address information as written.
- Match document labels with their corresponding values.
...
Do not confuse caste, sub-caste, category, and religion.
Extract each field only when the document explicitly
supports it.
...
"""
    ...
    print("")
    print("=" * 70)
    print("GEMINI 2.5 FLASH-LITE RESULT - CASTE CERTIFICATE")
    print("=" * 70)
...
def save_result(result):
    ...
    logger.info(
        "Saving final Caste Certificate JSON..."
    )
    ...
    logger.info(
        "Caste Certificate JSON saved successfully"
    )
...
def main():
    ...
    logger.info("=" * 70)
    logger.info(
        "CASTE CERTIFICATE EXTRACTION PIPELINE STARTED"
    )
    logger.info("=" * 70)
    ...
    try:
        ...
        print("")
        print("=" * 70)
        print("FINAL CASTE CERTIFICATE JSON")
        print("=" * 70)
        ...
        logger.info(
            "CASTE CERTIFICATE EXTRACTION FINISHED SUCCESSFULLY"
        )
