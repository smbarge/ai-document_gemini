...
def extract_pan_data(document_path):
    ...
    logger.info("Document path: %s", document_path)
    ...
    logger.info("Detecting MIME type...")
    ...
    logger.info("Custom Extractor processing started")
    logger.info("==================================================")
    ...
    logger.info("Creating final JSON structure...")
    ...
    logger.info("Extracting Custom Extractor entities...")
    ...
    logger.info("==================================================")
    logger.info("PAN CARD EXTRACTION COMPLETED")
    logger.info("==================================================")
