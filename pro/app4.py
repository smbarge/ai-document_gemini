...
The following OCR text belongs to an Indian PAN card.
...
- Preserve the full name exactly as it appears.
- Preserve the father's name exactly as it appears.
...
def main():
    ...
    logger.info("")
    logger.info("=" * 60)
    logger.info("PAN CARD DATA EXTRACTION STARTED")
    logger.info("=" * 60)
    ...
    logger.info("=" * 60)
    logger.info("PAN CARD DATA EXTRACTION FINISHED")
    logger.info("=" * 60)
