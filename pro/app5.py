...
The following OCR text belongs to an Indian caste certificate.
...
- Preserve caste exactly as written.
- Preserve category exactly as written.
- Preserve certificate number exactly as written.
- Preserve dates exactly as written.
- Preserve district, taluka and village exactly as written.
...
def main():
    ...
    logger.info("")
    logger.info("=" * 60)
    logger.info("CASTE CERTIFICATE DATA EXTRACTION STARTED")
    logger.info("=" * 60)
    ...
    logger.info("=" * 60)
    logger.info("CASTE CERTIFICATE DATA EXTRACTION FINISHED")
    logger.info("=" * 60)
